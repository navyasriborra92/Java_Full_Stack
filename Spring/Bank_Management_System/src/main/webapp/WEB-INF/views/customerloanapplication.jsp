...
<body>
    <div class="container">
        ...
        <div class="main-content">
	        ...
	        <form action = "/Bank_Management_System/flm/loan/applyloan" method = "post">
				<h3>Welcome, ${name}!</h3>
                <p>Account Number: ${accountNumber}</p>
                <p>Email: ${email}</p>
				    ...
				    <select name="loanType" id="loanType">
				        <%
				            LoanType[] loanTypes = (LoanType[]) request.getAttribute("loanTypes");
				            if (loanTypes != null) {
                ...
                LoanAmount :$<input type = "text" name = "amount"><br><br>                
                EMI: $<input type = "text" name = "emi"><br><br>
                EMI Duration:<input type = "text" name = "emiduration"><br><br>
