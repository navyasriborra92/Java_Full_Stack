...
<body>
    <div class="container">
        ...
        <div class="main-content">
			...
			<p>Welcome ${admin.lastname}</p>
				<h2>Admin Reports</h2>
				<a href="/Bank_Management_System/flm/admin/reports/transactions/pdf" target="_blank">
				    Download Transaction Report (PDF)
				</a><br><br>
				
				<a href="/Bank_Management_System/flm/admin/reports/customers/pdf" target="_blank">
