...
<body>
    <div class="container">
        ...
        <div class="main-content">
	        ...
	        <form action = "/Bank_Management_System/flm/home/accountdetails" method = "get">
				<h3>Welcome, ${accountdetails.firstname}!</h3>
				<p>Available Balance: $${availablebalance}</p>
                <p>Account Number: ${accountdetails.firstname}</p>
                <p>Last Name: ${accountdetails.lastname}</p>
                <p>Date of Birth: ${accountdetails.dateofbirth}</p>
